...
- Given that users primarily use Mantine, use the mcp**contex7**search tool to retrieve latest Mantine component information and analyze implementation feasibility
